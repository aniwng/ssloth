#!/usr/bin/env node
/**
 * One-off: push the 5 hand-written articles in astro/src/lib/seed/roundups.json
 * into Sanity as real published documents, uploading each heroImage file as a
 * Sanity asset along the way.
 *
 * Not part of the generate-and-publish pipeline — that one drafts new
 * articles from the content calendar via Claude. This script exists once,
 * to seed Sanity with the content that already exists as static JSON.
 *
 *   PUBLIC_SANITY_PROJECT_ID=... SANITY_WRITE_TOKEN=... node migrate-seed.js
 *   node migrate-seed.js --dry-run   # print what would be written, upload nothing
 */
